  ...
  return (
    <div className="w-full relative">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(125% 125% at 50% 90%, #fff 30%, #24AEB1 100%)",
        }}
      />
      {/* Content Container */}
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="inline-flex items-center gap-3 self-start rounded-full bg-white px-4 py-2">
                {/* <SparkleIcon /> */}
                <span className="text-[11.9px] font-medium text-primary">
                  {badge.text}
                </span>
              </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                {buttons.primary && (
                  <Button
                    ...
                    className="h-[63.622px] gap-3 rounded-xl bg-primary px-8 text-[15.3px] hover:bg-[#029D9B]"
                  >
                ...
                {buttons.secondary && (
                  <Button
                    ...
                    variant="outline"
                    className="h-[63.622px] gap-3 rounded-xl border-primary px-8 text-[15.3px] text-primary hover:bg-blue-50"
                  >
            ...
            <div className="flex items-center justify-center lg:justify-end">
              <div className="w-full max-w-[559.929px] rounded-2xl bg-white p-8 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
                ...
                <form className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    className="h-[59.986px] w-full rounded-xl bg-primary text-[15.3px] hover:bg-[#029D9B]"
                  >
                    {formCard.submitText}
                  </Button>
                </form>
